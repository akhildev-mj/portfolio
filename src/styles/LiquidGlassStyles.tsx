...
const LiquidGlassStylesComponent: React.FC = () => (
	<style>{`
		...
		.grid-pattern { 
			...
			/* This part fades the grid out near the edges of the screen */
		...
		.liquid-glass::before, .liquid-glass-strong::before, .liquid-glass-strong-nav::before {
			content: ''; position: absolute; inset: 0; border-radius: inherit; padding: 1.5px; -webkit-mask: linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0); -webkit-mask-composite: xor; mask-composite: exclude; pointer-events: none;
		}

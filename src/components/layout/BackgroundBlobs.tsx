...
export const BackgroundBlobs = memo(() => (
	<div className='fixed inset-0 z-0 overflow-hidden pointer-events-none'>
      ...
      rounded-full blur-[40px] md:blur-[120px] 
      mix-blend-multiply dark:mix-blend-screen md:animate-[blobFloat_18s_ease-in-out_infinite_alternate]'
		/>
      ...
      rounded-full blur-[40px] md:blur-[110px] 
      mix-blend-multiply dark:mix-blend-screen md:animate-[blobFloat_22s_ease-in-out_infinite_alternate-reverse]'
		/>
	</div>
));

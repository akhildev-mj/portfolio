...
const projects = [
	{
		...
		description:
			'Machine learning model with interactive visualization for sales forecasting',
	...
	},
	{
		...
		description: 'Real-time tracking and analytics for retail businesses',
		imageUrl: '/placeholder.svg?height=800&width=600',
		category: 'Web Development'
	},
	{
		...
		description: 'Interactive charts and graphs for financial analysis',
		imageUrl: '/placeholder.svg?height=600&width=800',
	...
	},
	{
		...
		description:
			'Microservices architecture with authentication and rate limiting',
		imageUrl: '/placeholder.svg?height=800&width=600',
